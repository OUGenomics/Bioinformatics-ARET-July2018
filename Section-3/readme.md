...
```sh
usearch -usearch_global CAM_SMPL_SRA022063.fa -db SSURef_111_candidate_db.udb -id 0.7 -fastapairs f_hits.fasta -strand both -mincols 50 -maxhits 1 -qsegout CAM_SMPL_Fhits.fasta -blast6out CAM_SMPL_Fhits.tab
```
